            ...
            >
              <div className="rounded-2xl overflow-hidden bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl ring-1 ring-black/5 dark:ring-white/10">
                ...
                <div className="relative bg-slate-50 dark:bg-slate-900">
                  <div className="h-72 sm:h-80 w-full flex items-center justify-center p-3 sm:p-4">
                    <img
                      src={a.photo}
                      alt={a.name}
                      loading="lazy"
                ...
                <div className="p-5 sm:p-6">
                  <div className="mb-3">
                    <h3 className="text-lg sm:text-xl font-bold leading-snug text-gray-900 dark:text-white">
                      {a.name}
                    </h3>
