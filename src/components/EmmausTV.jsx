...
const EmmausTV = () => {
  ...
  return (
    <section id="emmaus-tv" className={`py-20 ${isDark ? 'bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900' : 'bg-gradient-to-br from-red-50 via-white to-red-50'}`}>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
                  ...
                  {videoSeries.map((series, index) => (
                    ...
                    >
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                        ...
                        <series.icon className={`w-5 h-5 ${series.color}`} />
                      </div>
              ...
              <div className="animate-fade-in-up" style={{ animationDelay: '600ms' }}>
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-gradient-to-r from-red-500 to-red-700 hover:from-red-600 hover:to-red-800 text-white px-8 py-4 rounded-full font-semibold text-lg transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
            ...
            <div className="relative group animate-fade-in-up" style={{ animationDelay: '300ms' }}>
              ...
              <div className={`relative p-6 rounded-2xl shadow-xl transform group-hover:-translate-y-2 transition-all duration-500 ${
                isDark ? 'bg-gray-800' : 'bg-white'
              }`}>
                <div className={`aspect-video rounded-xl flex items-center justify-center relative overflow-hidden ${
                  isDark ? 'bg-gradient-to-br from-gray-700 to-gray-600' : 'bg-gradient-to-br from-red-100 to-red-200'
                }`}>
                  {/* YouTube Play Button */}
                  ...
                  <div className="absolute bottom-4 right-4 w-2 h-2 bg-red-400 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
                  <div className="absolute top-1/2 right-6 w-4 h-4 bg-red-300 rounded-full animate-pulse" style={{ animationDelay: '2s' }}></div>
                </div>
