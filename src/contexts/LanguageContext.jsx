...
const translations = {
  en: {
    ...
    // Mission Section
    missionTitle: 'EMMAUS INSTITUTE OF THEOLOGY',
    missionDescription: 'With over six years of Gospel experience and in alignment with Genesis 14:14 ("...took a band of his trained men..."), the Emmaus Institute of Theology was founded to prepare and send a band of trained disciples for God\'s service.',
    ourMission: 'Our Mission',
    ourVision: 'Our Vision',
    ourMethod: 'Our Method',
    missionDesc: 'To Spread the Gospel to the Unreached Population to enable them to find their Saviour',
  ...
  te: {
    ...
    // Mission Section
    missionTitle: 'ఎమ్మాస్ ఇన్స్టిట్యూట్ ఆఫ్ థియాలజీ',
    missionDescription: 'ఆరు సంవత్సరాలకు మించిన సువార్త అనుభవంతో మరియు ఆదికాండం 14:14 ("...తన శిక్షణ పొందిన వారి బృందాన్ని తీసుకున్నాడు...") కు అనుగుణంగా, దేవుని సేవ కోసం శిక్షణ పొందిన శిష్యుల బృందాన్ని సిద్ధం చేసి పంపడానికి ఎమ్మాస్ ఇన్స్టిట్యూట్ ఆఫ్ థియాలజీ స్థాపించబడింది.',
    ourMission: 'మా లక్ష్యం',
    ourVision: 'మా దృష్టి',
    ourMethod: 'మా పద్ధతి',
    missionDesc: 'చేరని ప్రాంతాలలో సువార్తను వ్యాప్తి చేయడానికి శిష్యులను శిక్షణ ఇవ్వడం',
